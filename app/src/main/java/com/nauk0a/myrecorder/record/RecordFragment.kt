package com.nauk0a.myrecorder.record
...
import com.nauk0a.myrecorder.MainActivity
...
import com.nauk0a.myrecorder.databinding.FragmentRecordBinding
import java.io.File
...
class RecordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (!mainActivity.isServiceRunning()) {
            ...
            binding.playButton.setImageResource(R.drawable.ic_baseline_stop_circle_24)
        }
